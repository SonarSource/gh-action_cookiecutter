...
<img align="right" width="100" height="74"
alt="Port"
src="https://user-images.githubusercontent.com/8277210/183290025-d7b24277-dfb4-4ce1-bece-7fe0ecd5efd4.svg" />
...
In addition, as cookiecutter is an Open Source project you can make your own project. See the
[Cookiecutter tutorial](https://cookiecutter.readthedocs.io/en/2.0.2/tutorials.html#create-your-very-own-cookiecutter-project-template)
for details.
...
2. Install the Ports GitHub app from the
   [GetPort GitHub App installation page](https://github.com/apps/getport-io/installations/new).
...
See the
[GitHub exporter examples](https://docs.getport.io/build-your-software-catalog/sync-data-to-catalog/git/github/examples#mapping-repositories-and-issues)
